...
img = image.load('images\\towers\\bow_icon.png')
layer = 1

name = 'Bow and Arrow'
info = 'Slow firing, low damage arrow'

bullet_img = image.load('images\\towers\\arrow_icon.png')

class Bullet:

    def __init__(self, pos, slope, speed = 65):
        self.pos = list(pos)
        self.slope = slope
...
class Tower:
    ...
    def __init__(self, pos):
        ...
        self.barrel_img = image.load('images\\towers\\bow_icon.png')
