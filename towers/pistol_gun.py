...
img = image.load('images\\towers\\pistol_gun_icon.png')
layer = 1

name = 'Pistol Gun'
info = 'Slow firing, low damage gun'

bullet_img = image.load('images\\towers\\bullet.png')

class Bullet:

    def __init__(self, pos, slope, speed = 25):
        self.pos = list(pos)
        self.slope = slope
...
class Tower:
    ...
    def __init__(self, pos):
        ...
        self.barrel_img = image.load('images\\towers\\pistol_gun_barrel.png')
